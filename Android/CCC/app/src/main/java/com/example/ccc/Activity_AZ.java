...
public class Activity_AZ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search_cambio.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(Activity_AZ.this, Activity_Casa.class);
    ...
    private ArrayList<Casa> adicionarCasas() {
        ...
        casas.add(e);
        e = new Casa(nome[7], valor[7], image[17], contato[17], endereco[17]);
        casas.add(e);
        e = new Casa(nome[2], valor[2], image[2], contato[2], endereco[2]);
        casas.add(e);
        e = new Casa(nome[4], valor[4], image[4], contato[4], endereco[4]);
        casas.add(e);
        e = new Casa(nome[8], valor[8], image[8], contato[8], endereco[8]);
        casas.add(e);
        return casas;
    }
