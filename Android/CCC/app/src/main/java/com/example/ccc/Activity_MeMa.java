...
public class Activity_MeMa extends AppCompatActivity {
    ...
    String contato[] = {"+55 (11) 2501-7914",
            "+55 (11) 55487788",
            "+55 (11) 3003-2180",
            "+55 (11) 98778-0448",
            "+55 (11) 4051-2388",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sortMaMe = (Button) findViewById(R.id.sortMaMe);
        sortMaMe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openActivity_MaMe();
            }
        ...
        search_cambio.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(Activity_MeMa.this, Activity_Casa.class);
    ...
    private ArrayList<Casa> adicionarCasas() {
        ...
        Casa e = new Casa(nome[2], valor[18], image[2], contato[2], endereco[2]);
        casas.add(e);
        e = new Casa(nome[18], valor[17], image[18], contato[18], endereco[18]);
        casas.add(e);
        e = new Casa(nome[13], valor[16], image[13], contato[13], endereco[13]);
        casas.add(e);
        e = new Casa(nome[0], valor[15], image[0], contato[0], endereco[0]);
        casas.add(e);
        e = new Casa(nome[1], valor[14], image[1], contato[1], endereco[1]);
        casas.add(e);
        e = new Casa(nome[4], valor[13], image[4], contato[4], endereco[4]);
        casas.add(e);
        e = new Casa(nome[6], valor[12], image[6], contato[6], endereco[6]);
        casas.add(e);
        e = new Casa(nome[8], valor[11], image[8], contato[8], endereco[8]);
        casas.add(e);
        e = new Casa(nome[10], valor[10], image[10], contato[10], endereco[10]);
        casas.add(e);
        e = new Casa(nome[9], valor[9], image[9], contato[9], endereco[9]);
        casas.add(e);
        e = new Casa(nome[12], valor[8], image[12], contato[12], endereco[12]);
        casas.add(e);
        e = new Casa(nome[17], valor[7], image[17], contato[17], endereco[17]);
        casas.add(e);
        e = new Casa(nome[16], valor[6], image[16], contato[16], endereco[16]);
        casas.add(e);
        e = new Casa(nome[14], valor[5], image[14], contato[14], endereco[14]);
        casas.add(e);
        e = new Casa(nome[7], valor[4], image[7], contato[7], endereco[7]);
        casas.add(e);
        e = new Casa(nome[5], valor[3], image[5], contato[5], endereco[5]);
        casas.add(e);
        e = new Casa(nome[11], valor[2], image[11], contato[11], endereco[11]);
        casas.add(e);
        e = new Casa(nome[15], valor[1], image[15], contato[15], endereco[15]);
        casas.add(e);
        e = new Casa(nome[3], valor[0], image[3], contato[3], endereco[3]);
        casas.add(e);
        return casas;
    }
    ...
    public void openActivity_MaMe(){
        Intent intent = new Intent(this, Activity_MaMe.class);
        startActivity(intent);
    }
