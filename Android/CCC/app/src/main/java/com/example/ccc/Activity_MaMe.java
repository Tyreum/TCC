...
public class Activity_MaMe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search_cambio.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(Activity_MaMe.this, Activity_Casa.class);
    ...
    private ArrayList<Casa> adicionarCasas() {
        ...
        Casa e = new Casa(nome[3], valor[0], image[3], contato[3], endereco[3]);
        casas.add(e);
        ...
        casas.add(e);
        e = new Casa(nome[2], valor[18], image[2], contato[2], endereco[2]);
        casas.add(e);
        return casas;
    }
